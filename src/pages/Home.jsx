...
//             Sep 24-25 | 2026
//               </p>
//               <p className="text-base md:text-lg font-bold">Osaka | Japan </p>
//             </div>
//           </div>
  ...
  return (
    <>
      <div className="scroll-smooth relative h-[86vh] home flex flex-col md:flex-row py-12 scroll-x-hidden w-full">
        ...
        {/* Overlay - changed to grey */}
        <div className="absolute inset-0 bg-gray-700 bg-opacity-40 z-0"></div>

        {/* Content */}
        <div className="relative z-2 flex flex-col items-start px-1 md:px-8 mt-4 justify-center h-full text-gray-100 text-2xl md:text-3xl font-bold">

          <div className="flex flex-row items-end gap-4">
            <h1 className="text-gray-300 text-shadow-md font-bold text-5xl md:text-6xl">
              Sep
            </h1>

            <div className="flex flex-col justify-center items-start leading-tight">
              <p className="text-base md:text-lg font-bold text-gray-200">
                 24-25 | 2026
              </p>
              <p className="text-base md:text-lg font-bold text-gray-200">
                Osaka | Japan
          ...
          <h1 className="text-3xl md:text-6xl my-4 w-full md:w-[90vw] text-gray-100">
            World Science & Technology Summit
          </h1>
