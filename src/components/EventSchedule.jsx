...
const EventSchedule = ({ height, name, link }) => {
  ...
  return (
    <div className="w-full bg-[#a3a6a9] rounded-2xl mx-auto px-4 md:px-12 py-8 flex flex-col items-center">
      <p className="text-3xl font-semibold text-white">Event Schedule</p>
        ...
        {[1, 2].map((day) => (
          ...
          >
            ...
            <p className="text-base md:text-lg font-semibold drop-shadow-sm">
              {day === 1 ? (
                <>
                  24<sup>th</sup> Sep 2026
                </>
              ) : day === 2 ? (
                <>
                  25<sup>th</sup> Sep 2026
                </>
              ) : (""
                // <>
